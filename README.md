...
## Analysis of the Social Impact of Social Networks and Simulation of Future Scenarios

## About the Project

The **SocialDive Analytics Project** is an in-depth analysis of the social impact of social networks in contemporary society, combined with a simulation of future scenarios inspired by the episode "NoseDive" from the series Black Mirror. This project integrates qualitative analysis of academic articles with quantitative simulations to explore how social scoring systems can affect social stratification and mobility.

## Methodology

The project combines two methodological approaches:

1. **Qualitative Analysis**: Extraction and analysis of key concepts, positive and negative impacts of four academic articles on social networks and their impact on society.

2. **Quantitative Simulation**: Development of a computational model that simulates a society based on social scoring, considering factors such as socioeconomic class, educational level, social conformity and access to technology.
...
- **Privileged** (4.0-4.5): Individuals with high digital social status
- **Standard Citizen** (3.0-4.0): The majority of the population
- **Marginalized** (2.0-3.0): People with low digital social status
- **Digital Excluded** (below 2.0): Individuals practically invisible in the system
...
1. **Reproduction of Inequalities**: Digital social stratification tends to reproduce and amplify existing socioeconomic inequalities.

2. **Determinants of Mobility**: Access to technology and educational level are determining factors for social mobility in a scoring system.

3. **Conformity vs. Authenticity**: People with higher social conformity tend to benefit more in scoring systems, while authenticity may be penalized.

4. **Echo Chambers**: The formation of social bubbles is a natural phenomenon in scoring-based networks, reinforcing polarization.

5. **Digital Matthew Effect**: It is observed that "the rich get richer, the poor get poorer" in the evolution of scores over time.

6. **Barriers to Mobility**: Upward social mobility is more difficult for lower socioeconomic classes, creating a cycle of digital exclusion.

## Ethical and Social Implications

- **Erosion of Privacy**: Social scoring systems require constant surveillance of individual actions.
- **Excessive Conformity**: People may sacrifice authenticity and critical thinking to maximize scores.
- **Algorithmic Discrimination**: Vie